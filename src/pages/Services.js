    ...
    <Body Services>
      ...
      <Grid>
        <Service>
          ...
          <Details><H3>CREATIVE BUSINESS IDEA</H3><p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Repellendus, aliquid eos! Id, dignissimos sit. Nostrum nihil esse omnis recusandae non! Ratione quia, incidunt dolorum cupiditate repudiandae corporis atque possimus pariatur.</p></Details>
        </Service>
        <Service>
          ...
          <Details><H3>BEST TEAMWORK EVER</H3><p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Repellendus, aliquid eos! Id, dignissimos sit. Nostrum nihil esse omnis recusandae non! Ratione quia, incidunt dolorum cupiditate repudiandae corporis atque possimus pariatur.</p></Details>
        </Service>
        <Service>
          <Icon><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" className="w-5 h-5">
          ...
          <Details><H3>BUSINESS IMPLEMENTATION</H3><p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Repellendus, aliquid eos! Id, dignissimos sit. Nostrum nihil esse omnis recusandae non! Ratione quia, incidunt dolorum cupiditate repudiandae corporis atque possimus pariatur.</p></Details>
        </Service>
        <Service>
          <Icon><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" className="w-5 h-5">
          ...
          <Details><H3>BEST STRATEGY</H3><p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Repellendus, aliquid eos! Id, dignissimos sit. Nostrum nihil esse omnis recusandae non! Ratione quia, incidunt dolorum cupiditate repudiandae corporis atque possimus pariatur.</p></Details>
        </Service>
        <Service>
          <Icon><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" className="w-5 h-5">
          ...
          <Details><H3>TRAINING OF EMPLOYEE</H3><p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Repellendus, aliquid eos! Id, dignissimos sit. Nostrum nihil esse omnis recusandae non! Ratione quia, incidunt dolorum cupiditate repudiandae corporis atque possimus pariatur.</p></Details>
        </Service>
        <Service>
          <Icon><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" className="w-5 h-5">
          ...
          <Details><H3>BUSINESS PRIVACY</H3><p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Repellendus, aliquid eos! Id, dignissimos sit. Nostrum nihil esse omnis recusandae non! Ratione quia, incidunt dolorum cupiditate repudiandae corporis atque possimus pariatur.</p></Details>
        </Service>
      </Grid>
    </Body>
  )
